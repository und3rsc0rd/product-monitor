...
we use this in a staff-only channel on [underscord](https://discord.gg/UeWkrt7XTD)! it's private because the main author (Sienna) does not trust that her code won't fuck up at some point. web scraping is also inherently fragile - if a website layout changes too drastically, this code WILL break. this monitor is just to keep us alert in case any of us miss something!
...
## license
```
   Copyright 2025 suprstarrd & The underscord Staff, et al.
